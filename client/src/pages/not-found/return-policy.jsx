...
const ReturnPolicy = () => {
  return (
    <div className="px-24 py-6 text-gray-800">
      <div className="text-center mb-8">
        <h1 className="text-3xl text-primary font-bold">Our Return Policy</h1>
      </div>

      {/* Warranty Section */}
      <div className="mb-6">
        <h3 className="text-2xl font-semibold text-primary mb-2">Warranty</h3>
      ...
      <div className="mb-6">
        <h3 className="text-2xl font-semibold text-primary mb-2">Returns or Exchange</h3>
      ...
      {/* Policy Section */}
      <div className="mb-6">
        <h3 className="text-2xl font-semibold text-primary mb-2">Policy</h3>
      ...
      <div>
        <h3 className="text-2xl font-semibold text-primary mb-2">LCD/OLED Damage Warranty</h3>
